    ...
    function reduceEventStore(eventStore, action, eventSources, dateProfile, calendar) {
        switch (action.type) {
            ...
            case 'REMOVE_ALL_EVENT_SOURCES':
                console.log("sdakjhdkasjdkjadshkjdashjdaskhjaksdhdaskj");
                return filterEventStoreDefs(eventStore, function (eventDef) {
    ...
    var Calendar = /** @class */ (function () {
        ...
        */
        ...
        Calendar.prototype.removeEvent = function (id) {
            var defId = '';
            var instances = this.state.eventStore.instances;


            for (var property in instances) {
                if (id == instances[property].id) {
                    defId = instances[property].defId;
                }
            }
            var arr = this.state.eventStore.defs;
            delete this.state.eventStore.defs[defId];
            delete this.state.eventStore.instances[id];
